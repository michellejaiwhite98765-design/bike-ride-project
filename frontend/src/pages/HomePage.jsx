...
function HomePage() {
  ...
  useEffect(() => {
    ...
    rideService
      ...
      .finally(() => {
        if (!cancelled) setLoadingMyRides(false);
      });
    return () => {
      cancelled = true;
    };
...
<main>
        ...
        {user && (
          <section className="br-section br-light-section" id="my-rides">
            <div className="br-container">
              <div className="br-section-heading split">
                <div>
                  <Tag className="br-section-tag">YOUR RIDES</Tag>
                  <h2>Rides you're part of.</h2>
                  <p>Everything you're driving or riding, in one place.</p>
                </div>
                <Button type="link" onClick={() => navigate("/rides/mine")}>
                  View all my rides <ArrowRightOutlined />
                </Button>
              </div>
              ...
              {loadingMyRides ? (
                ...
                <Empty description="You don't have any rides yet.">
                  <Button type="primary" onClick={offerRide}>
                    Offer a ride
                  </Button>
                </Empty>
              ) : (
                <div className="br-route-grid">
                  {myRides.slice(0, 6).map((ride) => (
