...
export default function MyRidesPage() {
  ...
  return (
    <div className="my-rides-page">
      ...
      <style>{`
        .my-rides-page{position:relative;min-height:100vh;padding:38px 0 64px;background:radial-gradient(circle at 8% 0%,rgba(219,234,254,.85),transparent 28%),radial-gradient(circle at 96% 12%,rgba(224,231,255,.75),transparent 30%),linear-gradient(180deg,#05070d 0%,#05070d 72%);overflow:hidden;color:${HOME.text};}
        .my-rides-page *{box-sizing:border-box;}
        .my-rides-glow{position:absolute;border-radius:999px;filter:blur(5px);pointer-events:none;}.glow-one{width:260px;height:260px;right:-120px;top:230px;background:rgba(96, 165, 250, 0.16)}.glow-two{width:220px;height:220px;left:-130px;bottom:160px;background:rgba(167, 139, 250, 0.14)}
        .my-rides-container{width:min(1240px,calc(100% - 40px));margin:0 auto;position:relative;z-index:1;}
        .my-rides-header{display:flex;justify-content:space-between;align-items:flex-end;gap:24px;margin-bottom:28px;}.my-rides-eyebrow{display:inline-flex;align-items:center;gap:7px;border-radius:999px;background:${HOME.soft};color:${HOME.primary};padding:7px 11px;font-size:11px;font-weight:800;letter-spacing:.9px;}.my-rides-header h1{margin:15px 0 8px;color:${HOME.dark};font-size:clamp(34px,4vw,50px);line-height:1;letter-spacing:-2.5px;font-weight:850}.my-rides-header p{max-width:650px;margin:0;color:${HOME.muted};font-size:15px;line-height:1.65}.create-ride-btn{height:48px!important;border-radius:12px!important;background:${HOME.primary}!important;border-color:${HOME.primary}!important;box-shadow:0 10px 25px rgba(45, 212, 191, 0.25);font-weight:700;}
        .my-rides-overview{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:22px}.overview-card{display:flex;align-items:center;gap:13px;background:rgba(11, 15, 23, 0.9);border:1px solid rgba(255, 255, 255, 0.1);border-radius:16px;padding:15px 17px;box-shadow:0 8px 25px rgba(0, 0, 0, 0.4);backdrop-filter:blur(10px)}.overview-icon{width:42px;height:42px;border-radius:13px;display:grid;place-items:center;font-size:18px}.overview-icon.blue{background:rgba(45, 212, 191, 0.12);color:#2DD4BF}.overview-icon.green{background:rgba(34, 197, 94, 0.14);color:#22C55E}.overview-icon.purple{background:rgba(167, 139, 250, 0.12);color:#A78BFA}.overview-card small{display:block;color:${HOME.muted};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px}.overview-card strong{display:block;margin-top:2px;color:${HOME.dark};font-size:18px}.route-overview{position:relative}.route-overview .ant-tag{margin-left:auto}
        .my-rides-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:20px}.my-rides-card{background:rgba(11, 15, 23, 0.92);border:1px solid ${HOME.border};border-radius:22px;overflow:hidden;box-shadow:0 16px 45px rgba(0, 0, 0, 0.4);transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease}.my-rides-card:hover{transform:translateY(-2px);box-shadow:0 22px 55px rgba(0, 0, 0, 0.5)}.my-rides-card.is-live{border-color:rgba(45, 212, 191, 0.3);box-shadow:0 18px 50px rgba(45, 212, 191, 0.16)}
        .my-rides-card-top{height:48px;padding:0 14px 0 18px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255, 255, 255, 0.08)}.my-rides-live-badge{display:inline-flex;align-items:center;gap:7px;color:${HOME.muted};font-size:10px;font-weight:850;letter-spacing:.8px}.live-dot{width:7px;height:7px;border-radius:50%;background:#94a3b8}.live-dot.pulse{background:#22C55E;box-shadow:0 0 0 5px rgba(22,163,74,.10);animation:livePulse 1.8s infinite}.my-rides-card-top .ant-btn{color:#94A3B8}.my-rides-card-top .ant-btn:hover{color:${HOME.primary};background:${HOME.soft}}@keyframes livePulse{0%,100%{opacity:1}50%{opacity:.4}}
        .my-rides-summary{padding:18px 20px 15px}.my-rides-summary-top{display:flex;align-items:center;gap:12px}.my-rides-avatar-wrap{position:relative}.online-dot{position:absolute;right:-1px;bottom:1px;width:11px;height:11px;background:#22c55e;border:2px solid #0B0F17;border-radius:50%}.my-rides-driver{flex:1;min-width:0}.my-rides-driver strong{display:block;color:${HOME.dark};font-size:15px}.my-rides-driver span{display:block;color:${HOME.muted};font-size:12px;margin-top:3px}.my-rides-summary .ant-tag{margin:0}
        .my-rides-route-summary{display:grid;grid-template-columns:30px minmax(0,1fr) 25px 30px minmax(0,1fr);align-items:center;gap:8px;margin-top:18px;padding:13px;border-radius:15px;background:rgba(11, 15, 23, 0.7);border:1px solid rgba(255, 255, 255, 0.06)}.route-icon{width:30px;height:30px;border-radius:9px;display:grid;place-items:center;font-size:14px}.route-icon.start{color:#2DD4BF;background:rgba(45, 212, 191, 0.12)}.route-icon.end{color:#A78BFA;background:rgba(167, 139, 250, 0.12)}.route-copy{min-width:0}.route-copy span{display:block;color:#94a3b8;font-size:9px;text-transform:uppercase;font-weight:800;letter-spacing:.6px}.route-copy strong{display:block;color:${HOME.dark};font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:3px}.route-arrow{color:#94a3b8;font-size:12px}
        ...
        .my-rides-progress{margin:0 20px;padding:15px 0 17px;border-top:1px solid rgba(255, 255, 255, 0.08)}.my-rides-progress-head{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px}.my-rides-section-label{font-size:9px;font-weight:850;letter-spacing:.8px;color:#94a3b8}.my-rides-progress-title{font-size:14px;font-weight:750;color:${HOME.dark};margin-top:3px}.my-rides-progress-percent{font-size:18px;font-weight:850;color:${HOME.primary}}.my-rides-progress .ant-progress{margin:0}.my-rides-route-line{position:relative;display:grid;grid-template-columns:1fr auto 1fr;align-items:start;gap:8px;margin-top:13px}.my-rides-route-line:before{content:"";position:absolute;left:14px;right:14px;top:13px;border-top:1px dashed rgba(255, 255, 255, 0.15);z-index:0}.route-stop{position:relative;z-index:1;display:flex;gap:7px;min-width:0}.route-stop:last-child{justify-content:flex-end;text-align:right}.route-dot{width:27px;height:27px;flex:0 0 27px;display:grid;place-items:center;border-radius:50%;background:rgba(255, 255, 255, 0.08);color:#94a3b8;border:3px solid #0B0F17;box-shadow:0 2px 6px rgba(0, 0, 0, 0.4);font-size:11px}.route-stop.active .route-dot{background:${HOME.primary};color:white}.route-dot.end{background:rgba(255, 255, 255, 0.08)}.route-stop div{min-width:0}.route-stop span:not(.route-dot){display:block;color:#94a3b8;font-size:9px}.route-stop strong{display:block;color:${HOME.dark};font-size:10px;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:125px}.route-current{position:relative;z-index:2;display:flex;align-items:center;gap:4px;padding:5px 8px;border-radius:999px;background:#0B0F17;border:1px solid rgba(255, 255, 255, 0.12);color:${HOME.primary};font-size:9px;font-weight:750;white-space:nowrap;box-shadow:0 3px 8px rgba(0, 0, 0, 0.4)}
        .my-rides-live-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:rgba(255, 255, 255, 0.08);border-top:1px solid rgba(255, 255, 255, 0.08)}.live-stat{display:flex;align-items:center;gap:8px;background:#0B0F17;padding:11px 12px}.live-stat-icon{width:27px;height:27px;border-radius:8px;display:grid;place-items:center;background:rgba(45, 212, 191, 0.12);color:#2DD4BF;font-size:12px}.live-stat-icon.speed{background:rgba(34, 197, 94, 0.14);color:#22C55E}.live-stat-icon.eta{background:rgba(167, 139, 250, 0.12);color:#A78BFA}.live-stat small{display:block;color:#94a3b8;font-size:9px}.live-stat strong{display:block;color:${HOME.dark};font-size:11px;margin-top:2px}.my-rides-live-stats.muted{display:flex;align-items:center;gap:8px;padding:12px 20px;background:#0B0F17;color:${HOME.muted};font-size:11px;border-top:1px solid rgba(255, 255, 255, 0.08)}.stat-live-dot{width:7px;height:7px;border-radius:50%;background:#94a3b8}
        .my-rides-map-shell{padding:12px;background:#0B0F17}.my-rides-map-shell .live-tracking-card{margin:0!important;border:0!important;box-shadow:none!important}.my-rides-map-shell .ant-card-head{display:none}.my-rides-map-shell .live-map-frame{height:220px!important;border-radius:14px!important}.my-rides-map-shell .live-map-stats{display:none}.my-rides-map-shell .live-map-overlay{display:flex}
        .my-rides-card-footer{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 20px;border-top:1px solid rgba(255, 255, 255, 0.08)}.tracking-note{display:flex;align-items:center;gap:7px;min-width:0;color:${HOME.muted};font-size:10px}.tracking-icon{width:23px;height:23px;display:grid;place-items:center;flex:0 0 23px;border-radius:7px;background:${HOME.soft};color:${HOME.primary}}.my-rides-card-footer .ant-btn{height:34px;border-radius:9px;background:${HOME.primary};border-color:${HOME.primary};font-size:11px;font-weight:700;box-shadow:none}
        .my-rides-loading{display:grid;grid-template-columns:1fr 1fr;gap:20px}.my-rides-loading .ant-skeleton{background:#0B0F17;border-radius:18px;padding:20px}.my-rides-empty{min-height:340px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:15px;background:rgba(11, 15, 23, 0.85);border:1px solid ${HOME.border};border-radius:22px}.my-rides-empty .ant-btn{background:${HOME.primary};border-color:${HOME.primary};border-radius:10px}
